...
namespace Insania.News.Middleware;
...
public class LoggingMiddleware(RequestDelegate next)
{
    ...
    public async Task Invoke(HttpContext context, LogsApiNewsContext contextDB)
    {
        ...
        LogApiNews log = new("system", true, method, type, request, null);
