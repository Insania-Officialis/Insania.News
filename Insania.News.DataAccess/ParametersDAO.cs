...
public class ParametersDAO(ILogger<ParametersDAO> logger, NewsContext context) : IParametersDAO
{
    #region Зависимости
    /// <summary>
    /// Сервис логгирования
    ...
    public async Task<List<ParameterNews>> GetList()
    {
        try
        {
            //Логгирование
            ...
            List<ParameterNews> data = await _context.Parameters.Where(x => x.DateDeleted == null).ToListAsync();
