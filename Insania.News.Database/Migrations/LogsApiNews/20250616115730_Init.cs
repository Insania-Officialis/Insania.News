    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.EnsureSchema(
                name: "insania_logs_api_news");

            migrationBuilder.CreateTable(
                name: "r_logs_api_news",
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_r_logs_api_news", x => x.id);
                },
                comment: "Логи сервиса новостей");

            migrationBuilder.CreateIndex(
                name: "IX_r_logs_api_news_data_in",
                schema: "insania_logs_api_news",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_r_logs_api_news_data_out",
                schema: "insania_logs_api_news",
                table: "r_logs_api_news",
                column: "data_out")
                .Annotation("Npgsql:IndexMethod", "gin");
