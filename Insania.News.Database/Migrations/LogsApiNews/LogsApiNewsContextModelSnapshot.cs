...
namespace Insania.News.Database.Migrations.LogsApiNews
{
    ...
    partial class LogsApiNewsContextModelSnapshot : ModelSnapshot
    {
        protected override void BuildModel(ModelBuilder modelBuilder)
        {
#pragma warning disable 612, 618
            modelBuilder
                .HasDefaultSchema("insania_logs_api_news")
                .HasAnnotation("ProductVersion", "9.0.6")
                .HasAnnotation("Relational:MaxIdentifierLength", 63);

            NpgsqlModelBuilderExtensions.UseIdentityByDefaultColumns(modelBuilder);

            modelBuilder.Entity("Insania.News.Entities.LogApiNews", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("r_logs_api_news", "insania_logs_api_news", t =>
                        {
                            t.HasComment("Логи сервиса новостей");
                        });
                });
